...
var change=function (obj) {
    ...
    var imagesId=obj.imagesId;
    var imageCount=obj.imageCount;
    var directory=obj.directory;
    var imageType=obj.imageType;
    var spinnerId=obj.spinnerId;
	var ready = false,
...
//            $(spinnerId).html("");
	...
	*/
	function addSpinner () {
		spinner = new CanvasLoader(spinnerId.replace("#",""));
...
//		var imageName = "img/threesixty_" + (loadedImages + 1) + ".jpg";
		var imageName = directory+(loadedImages + 1) + imageType;
		/*
		...
		*/
		...
		// console.log(frames instanceOf Array)
		frames.push(image);
	...
	*/
	function imageLoaded() {
		...
		$(spinnerId+" span").text(Math.floor(loadedImages / totalFrames * 100) + "%");
		...
		if (loadedImages == totalFrames) {
			...
			*/
			$(spinnerId).fadeOut("slow", function(){
				spinner.hide();
				showThreesixty();
			});
		} else {
